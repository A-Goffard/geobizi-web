  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-content">
      ...
      <form @submit.prevent="guardarCambios" class="form-grid">
        ...
        <div class="form-group">
          <label for="edit-nombre_contacto">Nombre de Contacto:</label>
          <input type="text" id="edit-nombre_contacto" v-model="form.nombre_contacto">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="edit-email_empresa">Email:</label>
