    ...
    <section class="modalidades-trabajo">
      ...
      <div class="bloques-gestion">
        <div class="bloque-modalidad">
          ...
          <router-link to="/contacto?servicio=talleres_colegios" class="btn-servicio mleft">Preguntar sobre este servicio</router-link>
        </div>
        ...
        <div class="bloque-modalidad">
          ...
          <router-link to="/contacto?servicio=talleres_municipios" class="btn-servicio mleft">Consulta qué podemos hacer</router-link>
        </div>
        ...
        <div class="bloque-modalidad">
          ...
          <router-link to="/contacto?servicio=talleres_ferias" class="btn-servicio mleft">Preguntar sin compromiso</router-link>
        </div>
      </div>
    </section>
