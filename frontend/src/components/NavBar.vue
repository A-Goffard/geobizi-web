  ...
  <header :class="{ 'scrolled-nav': scrolledNav }">
    <nav>
      ...
      <ul v-show="!mobile" class="navigation">
        <li>
          <router-link class="NavButton link" :to="{ name: 'inicio' }" @click="closeMobileNav"
            title="Inicio">Inicio</router-link>
        </li>
        <li>
          <router-link class="NavButton link" :to="{ name: 'servicios' }" @click="closeMobileNav"
            title="Servicios">Servicios</router-link>
        </li>


        <li>
          <router-link class="NavButton link" :to="{ name: 'calendario' }" @click="closeMobileNav"
            title="Calendario">Calendario</router-link>
        </li>
        ...
        <li>
          <router-link class="NavButton link" :to="{ name: 'blog' }" @click="closeMobileNav"
            title="Blog">Blog</router-link>
        </li>
        <li>
          <router-link class="NavButton link" :to="{ name: 'contacto' }" @click="closeMobileNav"
      ...
      <div class="icon">
        <button @click="toggleMobileNav" v-show="mobile" aria-label="Alternar menú" title="Abrir/cerrar menú">
          <img :class="{ 'icon-active': mobileNav }" src="@/assets/Hojitas.png" class="hojitas"
            alt="Icono menú - Geobizi" title="Abrir menú">
        </button>
      </div>
