<template>
  ...
  const ogImage = 'https://www.geobizi.com/imagenes/blog/patrimonio.avif'
  ...
  const articles = ref([
    ...
    },
    {
      ...
      link: '/blog/dia-tierra',
      image: '/imagenes/blog/dia-tierra.avif',
    },
    {
      title: 'Jornadas de Patrimonio Europeo',
