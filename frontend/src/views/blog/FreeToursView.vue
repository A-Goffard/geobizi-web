  ...
  <div class="contenedor-principal">
    ...
    <div class="redes-sociales">
      ...
      <a href="https://www.tiktok.com/@geobizi" target="_blank" rel="noopener noreferrer" title="Geobizi en TikTok">
        <img src="@/assets/icons/tiktok.png" alt="Geobizi en TikTok" class="social-icon" loading="lazy" />
      </a>
    </div>
...
const pageUrl = 'https://www.geobizi.com/blog/free-tours'
const ogImage = 'https://www.geobizi.com/imagenes/blog/detalle/freetour1.avif'

useHead({
  title: '¿Qué es un Free Tour? Rutas de Naturaleza y Geología | Geobizi',
  meta: [
    { name: 'description', content: 'Descubre qué es y cómo funciona un Free Tour. Conoce las rutas guiadas de libre pago de Geobizi centradas en la geología y la naturaleza de Bizkaia.' },
    { name: 'robots', content: 'index, follow' },
    { name: 'author', content: 'Geobizi' },
    { name: 'theme-color', content: '#0b8a4c' },
    { name: 'language', content: 'es' },
    { property: 'og:title', content: 'Free Tours de Naturaleza: Qué son y cómo funcionan | Geobizi' },
    { property: 'og:description', content: 'Guía práctica sobre Free Tours: descubre las ventajas de las rutas de libre pago y cómo reservar nuestras salidas medioambientales.' },
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "@type": "Article",
        "headline": "Free Tours: Descubriendo la Naturaleza y Geología a tu Ritmo",
        "description": "Guía práctica sobre Free Tours: qué son, cómo funcionan y consejos para disfrutar de rutas medioambientales.",
        "image": ogImage,
        "author": {
          "@type": "Organization",
          "name": "Geobizi",
        ...
        "publisher": {
          ...
          // AÑADIDO TIKTOK AL SCHEMA PARA GOOGLE
          "sameAs": [
        ...
        "datePublished": "2024-06-15T08:00:00+01:00",
